...
set CLASSPATH=%APP_HOME%\lib\check-in-api-1.0-all.jar

@rem Execute CheckInApi
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CHECK_IN_API_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CHECK_IN_API_EXIT_CONSOLE%" exit 1
exit /b 1
